...
#=============================================================================
   def make_output_dir(self)->None:
      ...
      elif (self.computer=="uiuc_campus"):
         self.output_dir=self.campus_out_stem+self.output_stem
      else:
...
#=============================================================================
   def launch_run(self)->None:
      ...
      if (self.computer=='home'):
         ...
         subprocess.call('cp slurm_submit.uiuc-campus '+self.output_dir, shell='True')		
         os.chdir(self.output_dir)
         subprocess.call('sbatch slurm_submit.uiuc-campus', shell='True')		
         os.chdir('/home/ripley/teuk-fortran')
      else:
